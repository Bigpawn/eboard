...
var MessageHandlerInterceptorAdapter = /** @class */ (function () {
    function MessageHandlerInterceptorAdapter() {
    }
    MessageHandlerInterceptorAdapter.messageHandle = function (message) {
        // 判断是否有上层拦截器
    ...
    MessageHandlerInterceptorAdapter.handleAll = false; // 抛出所有消息？
    return MessageHandlerInterceptorAdapter;
}());
export { MessageHandlerInterceptorAdapter };
//# sourceMappingURL=MessageHandlerInterceptorAdapter.js.map