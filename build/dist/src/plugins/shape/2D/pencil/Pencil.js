...
var Pencil = /** @class */ (function (_super) {
    ...
    function Pencil(canvas, eBoardEngine) {
        ...
        _this.downHandler = function (o) {
            ...
            _this.eBoardCanvas.on('mouse:move', _this.moveHandler);
        };
        ...
        _this.upHandler = function (o) {
            ...
            _this.eBoardCanvas.off('mouse:move', _this.moveHandler);
        };
    ...
    Pencil.prototype.setEnable = function (enable) {
