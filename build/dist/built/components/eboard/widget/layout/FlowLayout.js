...
var FlowLayout = /** @class */ (function (_super) {
    ...
    FlowLayout.prototype.layout = function (flushCache) {
        ...
        var leftEdgeMargin = util.max([this.options.marginWidth || 0, this.options.marginLeft || 0], null), rightEdgeMargin = util.max([this.options.marginWidth || 0, this.options.marginRight || 0], null), topEdgeMargin = util.max([this.options.marginHeight || 0, this.options.marginTop || 0], null), bottomEdgeMargin = util.max([this.options.marginHeight || 0, this.options.marginBottom || 0], null), width = 0, height = 0;
        var xOffset = 0;
        var yOffset = 0;
