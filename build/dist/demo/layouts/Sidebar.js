        ...
        return (React.createElement(Layout.Sider, { collapsible: true, collapsed: this.state.collapsed, onCollapse: this.toggle },
            ...
            React.createElement(Menu, { theme: "dark", mode: this.state.mode, defaultSelectedKeys: ["1"] },
                React.createElement(Menu.Item, { key: "1" },
                    React.createElement(Link, { to: "/pager" },
                        React.createElement(Icon, { type: "edit" }),
                        React.createElement("span", { className: "nav-text" }, "Pager Canvas"))),
                React.createElement(Menu.Item, { key: "2" },
                    React.createElement(Link, { to: "/simple" },
                        React.createElement(Icon, { type: "home" }),
                        React.createElement("span", { className: "nav-text" }, "Simple Canvas"))),
                React.createElement(Menu.Item, { key: "3" },
                    React.createElement(Link, { to: "/html" },
                        React.createElement(Icon, { type: "check-square-o" }),
                        React.createElement("span", { className: "nav-text" }, "HTMLCanvas"))),
                React.createElement(Menu.Item, { key: "4" },
                    React.createElement(Link, { to: "/image" },
                        React.createElement(Icon, { type: "file" }),
                        React.createElement("span", { className: "nav-text" }, "ImageCanvas"))),
                React.createElement(Menu.Item, { key: "5" },
                    React.createElement(Link, { to: "/pdf" },
                        React.createElement(Icon, { type: "edit" }),
                        React.createElement("span", { className: "nav-text" }, "PdfCanvas")))),
